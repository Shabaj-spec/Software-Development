...
public class Matrix {
    ...
    public boolean equals(Matrix a) {
        assert a != null : "Matrix to compare to cannot be null";
     ...
     */
    public void negate() {
        assert height > 0 && width > 0 : "Matrix dimensions must be positive";
     ...
     */
    public Matrix add(Matrix b, Matrix res) throws IllegalArgumentException {
        if (b == null || res == null) {
            throw new NullPointerException("Matrix b or res cannot be null");
        }
     ...
     */
    public Matrix multiplyWithScalar(double s, Matrix res) throws IllegalArgumentException {
        if (res == null) {
     ...
     * Exceptions: if dimensions don't match up thrown an InputMismatchException
     */
    public Matrix multiplyWithMatrix(Matrix b, Matrix res) throws IllegalArgumentException {
        assert b != null : "Matrix b is null";
        assert res != null : "Matrix res is null";

        if (b == null || res == null) {
            throw new NullPointerException("Matrix b or res cannot be null");
        }
        if (b.getHeight() != width || res.getHeight() != height || res.getWidth() != b.getWidth()) {
