...
public class ChickenBot extends TimBot {
  private static final int OTHER_BOTS_PENALTY = 2000;
  private static final int ADJACENT_BOTS_PENALTY = 1000;
    ...
    if( energyLevel > 0 ) {
      ...
      for( int i = 0; i < scores.length; i++ ) {
        ...
        if( ( i != District.CURRENT ) && botsSensed[i] ) {
          scores[i] += OTHER_BOTS_PENALTY;
          adj = ADJACENT_BOTS_PENALTY;
        }
      }
